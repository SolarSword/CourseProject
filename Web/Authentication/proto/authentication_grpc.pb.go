...
type AuthenticationClient interface {
	Login(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*LoginStatus, error)
	Logout(ctx context.Context, in *LoginToken, opts ...grpc.CallOption) (*LoginStatus, error)
}
...
func (c *authenticationClient) Login(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*LoginStatus, error) {
	out := new(LoginStatus)
...
func (c *authenticationClient) Logout(ctx context.Context, in *LoginToken, opts ...grpc.CallOption) (*LoginStatus, error) {
	out := new(LoginStatus)
...
func (UnimplementedAuthenticationServer) Login(context.Context, *UserInfo) (*LoginStatus, error) {
...
func _Authentication_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticationServer).Login(ctx, req.(*UserInfo))
	}
...
func _Authentication_Logout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticationServer).Logout(ctx, req.(*LoginToken))
	}
	return interceptor(ctx, in, info, handler)
}
